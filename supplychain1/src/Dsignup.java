...
public class Dsignup extends JFrame {
	...
	public Dsignup() {
		...
		l9.setBounds(228,204, 53,25);
		panel.add(l9);
	 
		JLabel l10=new JLabel("PIN CODE");
		l10.setBounds(469,156, 53,25);
		panel.add(l10);
		...
		textField_3.setBounds(65, 206, 117, 20);
		panel.add(textField_3);
		textField_3.setColumns(10);
		
		final Label label_3 = new Label("");
		label_3.setBounds(382, 178, 62, 22);
		panel.add(label_3);
		...
		textField_5.setBounds(291, 206, 142, 20);
		...
		textField_6.setBounds(554, 158, 86, 20);
		...
		passwordField.setBounds(438, 373, 98, 20);
		panel.add(passwordField);
		
		passwordField_1 = new JPasswordField();
		passwordField_1.setBounds(438, 409, 98, 20);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try{
					...
					sta.executeQuery("insert into distributor values('" + smid + "' , '" + name + "' , '" + doorno + "' , '" + street + "' , '" +district+ "' , '" +state + "','" + spincode + "' , '" + sgstno + "' , '" + stinno + "' , '" + comp + "' , '" + emailid + "' , '" + smobileno + "' , '" + stype + "' )");
					sta.executeQuery("insert into dlogin values('" + emailid +"','" + password + "')");
					con.close();
					dispose();
					Distrub log=new Distrub(emailid);
					log.setVisible(true);
				}
		...
		label.setBounds(308, 374, 73, 22);
		panel.add(label);
		
		Label label_1 = new Label("CONFIRM PASSWORD");
		label_1.setBounds(308, 410, 112, 22);
		panel.add(label_1);
