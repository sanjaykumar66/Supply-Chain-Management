...
public class Rsignup extends JFrame {
	...
	public Rsignup() {
		...
		label_3.setBounds(437, 156, 61, 22);
		panel.add(label_3);
		...
		textField_6.setBounds(572, 158, 86, 20);
		...
		passwordField.setBounds(416, 373, 98, 20);
		panel.add(passwordField);
		
		passwordField_1 = new JPasswordField();
		passwordField_1.setBounds(416, 409, 98, 20);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(flag==1)
				{
					try{
						...
						sta.executeQuery("insert into retailer values('" + smid + "' , '" + doorno + "' , '" + street + "' , '" +district+ "' , '" +state + "','" + spincode + "' , '" + sgstno + "' , '" + stinno + "' , '" + comp + "' , '" + emailid + "' , '" + smobileno + "' , '" + stype + "','" + name + "' )");
						sta.executeQuery("insert into rlogin values('" + emailid +"','" + password + "')");
						con.close();
						dispose();
						Retail log=new Retail(emailid);
						log.setVisible(true);
					}
		...
		label.setBounds(294, 374, 73, 22);
		panel.add(label);
		
		Label label_1 = new Label("CONFIRM PASSWORD");
		label_1.setBounds(294, 407, 112, 22);
		panel.add(label_1);
